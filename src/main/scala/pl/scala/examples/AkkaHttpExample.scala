...
object TodoListServerExample extends FailFastCirceSupport {
  ...
  implicit private val system = ActorSystem(Behaviors.empty, "SprayExample")
  implicit private val executionContext = system.executionContext
  ...
  def listItems: Future[List[TodoItem]] = ToDoActor.ask(GetItems)
